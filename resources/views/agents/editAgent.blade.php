                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" placeholder="Name" value="{{ $agent->name }}" autocomplete="name" autofocus
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile" placeholder="017xxxxxxxx" value="{{ $agent->mobile }}" autocomplete="mobile"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="Email" value="{{ $agent->email }}" autocomplete="email"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="NID Number" name="nid" value="{{ $agent->nid }}" autocomplete="nid"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Home Address" name="address" value="{{ $agent->address }}" autocomplete="address"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="City" name="city" value="{{ $agent->city }}" autocomplete="city"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" placeholder="Postal Code" name="postal_code" value="{{ $agent->postal_code }}" autocomplete="postal_code"
            ...
            function alertOnReject() {
                $(document).on('change', '#status', function() {
                    if($('#status').val() == 'Reject')
                        alert('Reject will delete this agent permanently. Are You sure?')
                })
            }
        });
    </script>
