...
@if(Auth::guard('admin_user')->user()->can('haveAdminAccess', App\Models\AdminUser::class))
    <div class="app-content main-content">
        <form action="{{ route('admin.assistants.update', $assistant->id) }}" enctype="multipart/form-data" method="post">
            @csrf 
            @method('patch')
            <div class="side-app">
                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select select2" name="status" id="status" required>
                                                ...
                                                <option value="Pending" @if($assistant->status == 'Pending') {{ 'selected' }} @endif>Pending</option>
...
|| Auth::guard('admin_user')->user()->can('haveModeratorAccess', App\Models\AdminUser::class))
    <div class="app-content main-content">
        <div class="side-app">
            <form action="{{ route('admin.assistants.update', $assistant->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" placeholder="Name" autofocus value="{{ $assistant->name }}"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile" placeholder="017xxxxxxxx" value="{{ $assistant->mobile }}"
                                    ...
                                    <div class=" col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="NID Number" name="nid" value="{{ $assistant->nid }}"
                                    ...
                                    <div class="col-sm-6 col-md-6 hide Company">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Driving License Number" name="driving_license" value="{{ $assistant->driving_license }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Home Address" name="address" value="{{ $assistant->address }}"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="City" name="city" value="{{ $assistant->city }}"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="ZIP Code" name="postal_code" value="{{ $assistant->postal_code }}"
            ...
            function alertOnReject() {
                $(document).on('change', '#status', function() {
                    if($('#status').val() == 'Reject')
                        alert('Reject will delete this assistant permanently. Are You sure?')
                })
            }
        });
    </script>
