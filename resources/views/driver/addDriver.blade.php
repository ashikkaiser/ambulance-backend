...
{{-- 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Driving License Number <span class="text-red">*</span></label>
                                            <input type="text" placeholder="Driving License Number" name="driving_license" value="{{ old('driving_license') }}"
                                            class="form-control @error('driving_license') is-invalid @enderror" autocomplete="nid" required>
                            ...
                            <div class=" card-body">
                                ...
                                <div class="row hide Company">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <input type="file" class="dropify" data-height="120" name="driving_license_pic" required/>
                                    </div>
                                </div>
                                <div class="row" style="height=60px !important">
