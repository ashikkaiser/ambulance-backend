                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control custom-select select2 category-select" name="category" value="{{ old('category') }}" required>
                                ...
                                <div class="col-sm-6 col-md-6 hide Company">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Trade License Number" name="trade_license" value="{{ old('trade_license') }}"
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        class="form-control @error('password') is-invalid @enderror" autocomplete="password" required>
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="ZIP Code" name="zip_code" value="{{ old('zip_code') }}"
                        ...
                        <div class=" card-body">
                            <div class="row">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <input type="file" class="dropify" data-height="240" name="profile_pic" value="{{ old('profile_pic') }}" required/>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <label class="form-label text-center">NID</label>
                                    <input type="file" class="dropify" data-height="240" name="nid_pic" required/>
                                </div>
                            </div>
